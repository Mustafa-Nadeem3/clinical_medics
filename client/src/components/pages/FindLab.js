            ...
            <div className="col-12">
              <div className="col-12 d-flex">
                ...
                <div className="col-5 pt-3">
                  <h5 className="mb-0 finder-text">Laboratory Name</h5>
                  <h6 className="mb-0 finder-text">Address</h6>
                  <a href="/" className="finder-text">Website Link</a>
                </div>
                <div className="col-5 pt-3 text-end">
                  <Link className="finder-button text-decoration-none" to="/testList" role="button">Lab Test</Link>
                </div>
              </div>
              <div className="col-12 d-flex">
