    ...
    <>
      ...
      <nav class="navbar fixed-top d-navbar mb-3 shadow">
        <div className="container justify-content-start">
          <Link class="nav-link text-secondary ms-3 me-4 cur-link rounded-bottom-1" to="/patientRecord">Record</Link>
        </div>
      </nav>
            ...
            <div className="col-12">
              <div className="col-12 d-flex">
                ...
                <div className="col-5 pt-3 text-end">
                  <Link className="text-decoration-none edit-button" to="/medicalRecord" role="button"><i class="fa-solid fa-file-medical me-2"></i>View Record</Link>
                </div>
              </div>
              <div className="col-12">
