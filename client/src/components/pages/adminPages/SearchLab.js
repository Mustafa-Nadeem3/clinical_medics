    ...
    <>
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-12 links mb-5">
              ...
              <Link className="nav-link text-primary current-link" to="/searchLab"><i className="fa-solid fa-user me-1"></i>Laboratory</Link>
      ...
      <nav class="navbar fixed-top d-navbar mb-3 shadow">
        <div className="container justify-content-start">
          <Link class="nav-link text-secondary ms-3 me-4 cur-link rounded-bottom-1" to="/searchLab">Search Labs</Link>
        </div>
      </nav>
            ...
            <div className="col-12">
              <div className="col-12 d-flex">
                ...
                <div className="col-5 pt-3">
                  <h5 className="mb-2">Lab Technician Name</h5>
                  <p className="mb-0">Lab Name</p>
                </div>
