    ...
    <>
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-12 links mb-5">
              <Link className="nav-link text-white" aria-current="page" to="/adminDashboard"><i className="fa-solid fa-display me-1"></i>Dashboard</Link>
      ...
      <nav class="navbar fixed-top d-navbar mb-3 shadow">
        <div className="container justify-content-start">
          <Link class="nav-link text-secondary ms-3 me-4 cur-link rounded-bottom-1" to="/searchPatient">Search Patients</Link>
        </div>
      </nav>
