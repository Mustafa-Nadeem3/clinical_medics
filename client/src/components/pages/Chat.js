    ...
    <>
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-12 links mb-5">
              ...
              <Link className="nav-link text-white" to="/calendar"><i className="fa-solid fa-calendar-days me-1"></i>Calender</Link>
              <Link className="nav-link text-white" to="/patientRecord"><i className="fa-solid fa-user me-1"></i>Patient Record</Link>
              <Link className="nav-link text-primary current-link" to="/chat"><i className="fa-solid fa-message me-1"></i>Chat</Link>
            </div>
      ...
      <nav class="navbar fixed-top d-navbar mb-3 shadow">
        <div className="container justify-content-start">
          <Link class="nav-link text-secondary ms-3 me-4 cur-link rounded-bottom-1" to="/chat">Chat</Link>
        </div>
      </nav>
